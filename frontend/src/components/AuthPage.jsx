    ...
    const handleGoogleLogin = async () => {
        ...
        try {
            ...
            if (code === 'auth/cancelled-popup-request') {
                setAuthError('Sign-in was interrupted by another request. Please try again.');
                return;
            }
    ...
    return (
        <div className="auth-overlay" onClick={handleOverlayClick}>
            ...
            >
                ...
                <button className="auth-google-btn" onClick={handleGoogleLogin} disabled={isSigningIn}>
